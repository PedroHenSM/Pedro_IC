...
def new_doubleArray(nelements):
    return _eureka.new_doubleArray(nelements)
new_doubleArray = _eureka.new_doubleArray

def delete_doubleArray(ary):
    return _eureka.delete_doubleArray(ary)
delete_doubleArray = _eureka.delete_doubleArray

def doubleArray_getitem(ary, index):
    return _eureka.doubleArray_getitem(ary, index)
doubleArray_getitem = _eureka.doubleArray_getitem
