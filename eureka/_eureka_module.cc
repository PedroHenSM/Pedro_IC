...
#define SWIGTYPE_p_problem__F101Truss10Bar swig_types[2]
#define SWIGTYPE_p_problem__Problem swig_types[3]
#define SWIGTYPE_p_problem__TrussBarStructureStaticProblem swig_types[4]
#define SWIGTYPE_p_std__shared_ptrT_problem__Problem_t swig_types[5]
